...
function categorize(loc) {
  ...
  if (path === "" || ["/about", "/contact", "/faq", "/gallery", "/install", "/privacy", "/terms", "/products", "/industries", "/projects", "/careers"].includes(path)) {
    return "main";
  }
...
const groups = { main: [], blog: [], services: [], products: [], other: [] };
